...
#define LEXICAL_ANALYZER_UNRECOGNIZED_CHARACTER      205
#define LEXICAL_ANALYZER_END_LINE                    206
#define LEXICAL_ANALYZER_INVALID_NUMBER              207
#define LEXICAL_ANALYZER_NUMBER_OUT_OF_RANGE         208
